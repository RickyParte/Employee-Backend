...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public List<EmployeeEntity> getAllEmployeesByPagination(Pageable pageable){
        List<EmployeeEntity> getAllEmployeeWithPagination= (List<EmployeeEntity>) employeeRepository.findAll(pageable).getContent();
        return getAllEmployeeWithPagination;
    }
